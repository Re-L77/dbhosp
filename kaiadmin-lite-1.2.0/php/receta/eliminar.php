                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">RECETAS - BAJA</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td><a href='baja.php?id=" . $row["id_receta"] . "' class='btn btn-danger btn-sm delete-btn' data-id='" . $row["id_receta"] . "'><i class='fas fa-trash-alt'></i></a></td>"; // Botón de borrar
                                                                echo "</tr>";
                                                            }
                                                        } else {
