                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">DOCTORES - BAJA</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Municipio</th>
                                                            <th>Estado</th>
                                                            <th>Borrar</th> <!-- Nueva columna para acciones -->
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td>" . $row["ap_paterno_doc"] . "</td>";
                                                                echo "<td>" . $row["ap_materno_doc"] . "</td>";
                                                                echo "<td>" . $row["especialidad"] . "</td>";
                                                                echo "<td>" . $row["telefono_doc"] . "</td>";
                                                                echo "<td>" . $row["calle_doc"] . "</td>";
                                                                echo "<td>" . $row["numero_calle_doc"] . "</td>";
                                                                echo "<td>" . $row["colonia_doc"] . "</td>";
                                                                echo "<td>" . $row["municipio_doc"] . "</td>";
                                                                echo "<td>" . $row["estado_doc"] . "</td>";
                                                                echo "<td><a href='baja.php?id=" . $row["id_doc"] . "' class='btn btn-danger btn-sm delete-btn' data-id='" . $row["id_doc"] . "'><i class='fas fa-trash-alt'></i></a></td>"; // Botón de borrar
                                                                echo "</tr>";
                                                            }
                                                        } else {
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                deleteButtons.forEach(function (button) {
                    button.addEventListener('click', function (event) {
                        ...
                        var confirmDelete = confirm('¿Estás seguro de que deseas eliminar al doctor con ID ' + patientId + '?');
                        if (!confirmDelete) {
