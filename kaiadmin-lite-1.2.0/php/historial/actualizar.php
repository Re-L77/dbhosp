...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron datos de la historial.";
    exit();
}
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">HISTORIAL - EDITAR <?php echo "[", $id_historial, "]"; ?>
                                    </h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="./modificar.php" method="post"
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <input type="text" class="form-control" id="id_historial"
                                                        name="id_historial" value="<?php echo $row['id_historial']; ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="fecha_hist"
                                                        name="fecha_hist" value="<?php echo $row['fecha_hist']; ?>"
                                                        required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="diagnostico"
                                                        name="diagnostico" value="<?php echo $row['diagnóstico']; ?>"
                                                        required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="tratamiento"
                                                        name="tratamiento" value="<?php echo $row['tratamiento']; ?>"
                                                        required>
                                                </div>
