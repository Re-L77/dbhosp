                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">CITA - EDITAR</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                echo "<tr>";
                                                                echo "<th scope='row'>" . $row["id_cita"] . "</th>";
                                                                echo "<td>" . $row["id_paciente"] . "</td>";
                                                                echo "<td>" . $row["id_doc"] . "</td>";
                                                                echo "<td>" . $row["fecha_hora"] . "</td>";
                                                                echo "<td><a href='actualizar.php?id=" . $row["id_cita"] . "' class='btn btn-warning btn-sm warning-btn' data-id='" . $row["id_cita"] . "'><i class='fas fa-edit'></i></a></td>"; // Botón de borrar
                                                                echo "</tr>";
                                                            }
                                                        } else {
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                deleteButtons.forEach(function (button) {
                    button.addEventListener('click', function (event) {
                        ...
                        var confirmDelete = confirm('¿Estás seguro de que deseas eliminar la cita con ID ' + patientId + '?');
                        if (!confirmDelete) {
