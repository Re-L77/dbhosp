...
include '../conex.php';
// Obtener el ID del cita desde la URL
$id_cita = $_GET['id'];

// Obtener los datos del cita
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">CITA - EDITAR <?php echo "[", $id_cita, "]"; ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                        ...
                                        $query2 = "SELECT id_doc FROM doctor";
                                            ...
                                            <form action="./modificar.php" method="post"
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <input type="text" class="form-control" id="id_cita" name="id_cita"
                                                        value="<?php echo $row['id_cita']; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="id_paciente">ID Paciente</label>
                                                    <select class="form-select" id="id_paciente" name="id_paciente"
                                                        required>
                                                        <?php while ($row_paciente = mysqli_fetch_assoc($result)) { ?>
                                                            <option value="<?php echo $row_paciente['id_paciente']; ?>"
                                                                <?php if ($row_paciente['id_paciente'] == $row['id_paciente'])
                                                                    echo 'selected'; ?>>
                                                                <?php echo $row_paciente['id_paciente']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="id_doc" name="id_doc" required>
                                                        <?php while ($row_doc = mysqli_fetch_assoc($result2)) { ?>
                                                            <option value="<?php echo $row_doc['id_doc']; ?>" <?php if ($row_doc['id_doc'] == $row['id_doc'])
                                                                   echo 'selected'; ?>>
                                                                <?php echo $row_doc['id_doc']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="fecha_hora"
                                                        name="fecha_hora"
                                                        value="<?php echo date('Y-m-d\TH:i', strtotime($row['fecha_hora'])); ?>"
                                                        required>
                                                </div>
