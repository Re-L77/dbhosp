...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron datos de la receta.";
    exit();
}
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">RECETAS - EDITAR <?php echo "[", $id_receta, "]"; ?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                        include "../conex.php";
                                        $query_historial = "SELECT id_historial FROM historial";
                                        ...
                                        <div class="col-md-12">
                                            <form action="./modificar.php" method="post"
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <input type="text" class="form-control" id="id_receta"
                                                        name="id_receta" value="<?php echo $row['id_receta']; ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="id_historial" name="id_historial"
                                                        ...
                                                        <?php while ($row_historial = mysqli_fetch_assoc($result_historial)) { ?>
                                                            <option value="<?php echo $row_historial['id_historial']; ?>"
                                                                <?php if ($row_historial['id_historial'] == $row['id_historial'])
                                                                    echo 'selected'; ?>>
                                                                <?php echo $row_historial['id_historial']; ?>
                                                            </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="medicamento"
                                                        ...
                                                        value="<?php echo $row['medicamento']; ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="instrucciones"
                                                        name="instrucciones"
                                                        value="<?php echo $row['instrucciones']; ?>" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="dosis">Dosis</label>
                                                    <input type="text" class="form-control" id="dosis" name="dosis"
                                                        value="<?php echo $row['dosis']; ?>" required>
                                                </div>
