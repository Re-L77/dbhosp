...
$sql = "SELECT * FROM doctor WHERE id_doc = $id_doctor";
...
if ($result->num_rows > 0) {
    ...
    echo "No se encontraron datos del doctor.";
    exit();
}
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">DOCTORES - EDITAR</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="./modificar.php" method="post"
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <input type="text" class="form-control" id="id_doctor"
                                                        name="id_doctor" value="<?php echo $row['id_doc']; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nombre_doc">Nombre</label>
                                                    <input type="text" class="form-control" id="nombre_doc"
                                                        name="nombre_doc" value="<?php echo $row['nombre_doc']; ?>"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ap_paterno_doc">Apellido Paterno</label>
                                                    <input type="text" class="form-control" id="ap_paterno_doc"
                                                        name="ap_paterno_doc"
                                                        value="<?php echo $row['ap_paterno_doc']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ap_materno_doc">Apellido Materno</label>
                                                    <input type="text" class="form-control" id="ap_materno_doc"
                                                        name="ap_materno_doc"
                                                        value="<?php echo $row['ap_materno_doc']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="especialidad">Especialidad</label>
                                                    <input type="text" class="form-control" id="especialidad"
                                                        name="especialidad" value="<?php echo $row['especialidad']; ?>"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="telefono_doc">Teléfono</label>
                                                    <input type="text" class="form-control" id="telefono_doc"
                                                        name="telefono_doc" value="<?php echo $row['telefono_doc']; ?>"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="calle_doc">Calle</label>
                                                    <input type="text" class="form-control" id="calle_doc"
                                                        name="calle_doc" value="<?php echo $row['calle_doc']; ?>"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="numero_calle_doc">Número</label>
                                                    <input type="text" class="form-control" id="numero_calle_doc"
                                                        name="numero_calle_doc"
                                                        value="<?php echo $row['numero_calle_doc']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="colonia_doc">Colonia</label>
                                                    <input type="text" class="form-control" id="colonia_doc"
                                                        name="colonia_doc" value="<?php echo $row['colonia_doc']; ?>"
                                                        required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="municipio_doc">Municipio</label>
                                                    <input type="text" class="form-control" id="municipio_doc"
                                                        name="municipio_doc"
                                                        value="<?php echo $row['municipio_doc']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="estado_doc">Estado</label>
                                                    <input type="text" class="form-control" id="estado_doc"
                                                        name="estado_doc" value="<?php echo $row['estado_doc']; ?>"
                                                        required>
                                                </div>
