                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">PACIENTES - BAJAS</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <?php
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td><a href='baja.php?id=" . $row["id_paciente"] . "' class='btn btn-danger btn-sm delete-btn' data-id='" . $row["id_paciente"] . "'><i class='fas fa-trash-alt'></i></a></td>"; // Botón de borrar
                                                                echo "</tr>";
                                                            }
                                                        } else {
